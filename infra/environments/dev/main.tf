###############################################################################
# Environment: DEV  -> dev.nextgendentalaustintx.com
...
module "site" {
  ...
  bucket_name         = "nextgendentalaustintx-website-dev"
  domain_names        = ["dev.nextgendentalaustintx.com"]
  acm_certificate_arn = var.wildcard_certificate_arn
  hosted_zone_id      = "Z0521096EYJDRL5ITYES"
  function_name       = "RewriteToIndexHtml-dev"
  function_code       = local.rewrite_function_code
  comment             = "nextgendentalaustintx-website-dev"
}
