...
|---|---|---|---|
| Correct Ads account selected | NextGen Dental (verify name on screen) | | |
| Plan A package digest matches manifest | see import/CHECKSUMS.txt | | |
| Campaigns imported | 1 — "Search \| Dental Implants \| South Austin" | | |
| Campaign status | Paused | | |
| Daily budget | $8.00 | | |
| Bid strategy / max CPC | Manual CPC / $6.00 | | |
| Networks | Google search only (Display OFF, Partners OFF) | | |
| Languages | English | | |
...
Reviewer: ____________  Date (UTC): ____________
If ANY row mismatches the plan: do not post; regenerate, re-approve, re-preview.
